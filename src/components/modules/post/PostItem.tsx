...
import type { PostMode } from './fab/PostsSortingFab'
import { PostItemHoverOverlay } from './PostItemHoverOverlay'
import { PostMetaBar } from './PostMetaBar'

export const PostItem = memo<{ data: PostModel; postMode: PostMode }>(
  function PostItem({ data, postMode }) {
    const displayText =
    ...
    return (
      ...
      >
        ...
        <div className={clsx('relative mt-4 space-y-2')}>
          <div className="relative overflow-hidden text-justify" />
        </div>
